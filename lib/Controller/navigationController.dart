...
//   final ExtraPointsService extraPointsService;
...
//     required this.extraPointsService,
...
//   }
//
//   bool isDeviationTooFar() {
//     List<LatLng> currentRoute = allRoutes[selectedRouteIndex];
//     double deviation = double.infinity;
//     for (LatLng point in currentRoute) {
...
//       List<LatLng> currentRoute = allRoutes[selectedRouteIndex];
//       List<LatLng> enhancedRoute =
//       extraPointsService.addExtraPoints(currentRoute, currentPosition);
//       updatePolylinePoints(enhancedRoute);
//     }
//   }
//
...
///VERY GOOD! But updates happen when you get closer to a point. Till then, the marker stays idle. T1.1
// import 'dart:async';
// import 'package:geolocator/geolocator.dart';
// import 'package:latlong2/latlong.dart';
// import '../Services/mapBoxDirectionService.dart';
...
//       List<LatLng> currentRoute = allRoutes[selectedRouteIndex];
//       LatLng closestPoint = findClosestPointOnPolyline(rawPosition, currentRoute);
//
...
//   }
//
//   LatLng findClosestPointOnPolyline(LatLng currentPosition, List<LatLng> polyline) {
...
//       LatLng point = projectPointOnLineSegment(currentPosition, start, end);
//       double distance = Geolocator.distanceBetween(
//         currentPosition.latitude,
//         currentPosition.longitude,
//         point.latitude,
...
//     List<LatLng> currentRoute = allRoutes[selectedRouteIndex];
//     int index = currentRoute.indexWhere((point) => point == newPoint);
//
//     if (index != -1) {
//       List<LatLng> coveredPart = currentRoute.sublist(0, index + 1);
